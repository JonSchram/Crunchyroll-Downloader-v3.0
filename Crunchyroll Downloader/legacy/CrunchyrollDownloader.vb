...
#Region "GetSoftsubs"
                ...
                ElseIf SoftSubsAvailable.Count > 0 Then
                    ...
                    For i As Integer = 0 To SoftSubsAvailable.Count - 1
                        ...
                        ' TODO: check that the default subtitle is the currently available subtitle
                        Dim defaultSub = False ' SoftSubsAvailable(i) = Main.DefaultSubCR
                        SoftSubsList.Add(New CR_Subtiles(SoftSubsAvailable(i), Main.HardSubValuesToDisplay(SoftSubsAvailable(i)), " -i " + """" + SoftSub_3 + """", i.ToString, defaultSub))
                    ...
                    Else
                        ...
                        For i As Integer = 0 To SoftSubsList.Count - 1
                            ...
                            If i = 0 And Not settings.IncludeLangaugeIfOneSubtitleFile Then
