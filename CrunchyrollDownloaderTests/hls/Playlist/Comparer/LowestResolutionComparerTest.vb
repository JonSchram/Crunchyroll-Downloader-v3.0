...
Namespace hls.playlist.comparer
    <TestClass>
    Public Class LowestResolutionComparerTest
        <TestMethod>
        Sub TestCompare_EqualResolutions()
            ...
            Dim comparer As New LowestResolutionComparer()
        ...
        ''' <summary>
        ''' Tests that the comparer chooses the lower resolution stream even if the low resolution stream has a higher bitrate.
        ''' </summary>
        <TestMethod>
